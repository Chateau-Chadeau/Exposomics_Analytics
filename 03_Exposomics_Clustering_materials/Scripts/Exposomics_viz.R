...
# Comparison
hclust_comparison_plot <- function(myhclust, shclust, simul){
  ...
  mycolours <- lighten(c("navy", "orange", "darkred"), amount = 0.5)
...
plot_clustering_comparison <- function(myhclust, shclust, simul){
  par(mfrow=c(1,3), xpd = T)
  hclust_dist_plot(myhclust)
  hclust_comparison_plot(myhclust, shclust, simul)
